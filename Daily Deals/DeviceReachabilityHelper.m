//
//  DeviceReachabilityHelper.h
//  Daily Deals
//
//  Created by Jordan Helzer on 12/5/11.
//  Copyright (c) 2011 HelzApps. All rights reserved.
//
//	*** NOTE *** This is a direct port of Apple's Reachability SDK Sample and will be customized
//	for Daily Deals
...
static DeviceReachabilityHelper *_sharedReachability;

// A class extension that declares internal methods for this class.
@interface DeviceReachabilityHelper()
...
@implementation DeviceReachabilityHelper
...
+ (DeviceReachabilityHelper *)sharedReachability
{
	if (!_sharedReachability) {
		_sharedReachability = [[DeviceReachabilityHelper alloc] init];
...
- (void)scheduleOnRunLoop:(NSRunLoop *)inRunLoop
{
	...
	if ([[DeviceReachabilityHelper sharedReachability] networkStatusNotificationsEnabled] == NO) {
		return;
	}
